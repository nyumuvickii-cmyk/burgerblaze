"""
Django settings for burgerblaze project.
"""
...
SECRET_KEY = 'django-insecure-change-me-in-production-use-environment-variable'
...
WSGI_APPLICATION = 'burgerblaze.wsgi.application'
ASGI_APPLICATION = 'burgerblaze.asgi.application'
